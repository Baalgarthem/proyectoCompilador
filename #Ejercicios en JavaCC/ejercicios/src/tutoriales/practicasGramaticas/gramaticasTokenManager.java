/* Generated By:JavaCC: Do not edit this line. gramaticasTokenManager.java */
package tutoriales.practicasGramaticas;

/** Token Manager. */
public class gramaticasTokenManager implements gramaticasConstants
{
...
/** Constructor. */
public gramaticasTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public gramaticasTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
