...
class test implements testConstants {
  public static void main(String[] args) throws Exception {
    // Obtener la ruta absoluta del archivo "programa.txt"    File file = new File("programa.txt");
    String absolutePath = file.getAbsolutePath();
    System.out.println("La ruta absoluta del archivo es: " + absolutePath);

    // Crear un FileInputStream para leer de programa.txt    FileInputStream stream = new FileInputStream(file);

    // Pasar el stream al constructor del analizador    test analizador = new test(stream);
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x800,0x808,0x808,0x3000,};
   }
