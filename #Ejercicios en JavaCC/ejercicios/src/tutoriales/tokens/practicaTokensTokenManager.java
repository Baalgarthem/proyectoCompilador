/* Generated By:JavaCC: Do not edit this line. practicaTokensTokenManager.java */
package tutoriales.tokens;

/** Token Manager. */
public class practicaTokensTokenManager implements practicaTokensConstants
{
...
/** Constructor. */
public practicaTokensTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public practicaTokensTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
